...
def hero_html(lang: str) -> str:
    ...
    hook = (
        "نوٹس دیکھا یا پڑھا؟"
        if is_ur
        else 'Did you <span class="hl">see</span> the notice, or <span class="hl">read</span> it?'
    )
...
def shell(lang: str, dark: bool, title: str, body_html: str, footer: str) -> str:
    ...
    series = "شہری خواندگی · پوسٹ ۸" if lang == "ur" else "Civic Literacy · Post 8"
...
FOOT_UR = "پاکستان میڈیا او ایس · شہری خواندگی · پوسٹ ۸"
FOOT_EN = "Pakistan Media OS · Civic Literacy · Post 8"

SLIDES_UR = [
    {
        "name": "POST-008-slide-ur-01.png",
        "dark": True,
        "title": "نوٹس دیکھا یا پڑھا؟",
        "body": '<p class="sub">جاری کنندہ · تاریخ · دائرہ کار</p><p class="sub" style="margin-top:18px">پوسٹ ۸</p>',
    },
    {
        "name": "POST-008-slide-ur-02.png",
        "dark": False,
        "title": "دفتری / اسکول گروپ",
        "body": (
            '<ul class="bullets">'
            '<li><span class="dot"></span><span>موٹی سطر: ٹائمنگ بدل گئی</span></li>'
            '<li><span class="dot"></span><span>پلان بدل گئے</span></li>'
            '<li><span class="dot"></span><span>فوٹ نوٹ نہیں دیکھا</span></li>'
            "</ul>"
        ),
    },
    {
        "name": "POST-008-slide-ur-03.png",
        "dark": False,
        "title": "پوسٹ ۷ سے",
        "body": (
            '<ul class="bullets">'
            '<li><span class="dot"></span><span>فارورڈ ≠ ثبوت</span></li>'
            '<li><span class="dot"></span><span>آج: نوٹس کیسے پڑھیں</span></li>'
            '<li><span class="dot"></span><span>عنوان ≠ پورا حکم</span></li>'
            "</ul>"
        ),
    },
    {
        "name": "POST-008-slide-ur-04.png",
        "dark": False,
        "title": "تین چیزیں",
        "body": (
            '<ul class="bullets">'
            '<li><span class="dot"></span><span>جاری کنندہ</span></li>'
            '<li><span class="dot"></span><span>تاریخ / میعاد</span></li>'
            '<li><span class="dot"></span><span>دائرہ کار</span></li>'
            '<li><span class="dot"></span><span>(+ عمل یا معلومات)</span></li>'
            "</ul>"
        ),
    },
    {
        "name": "POST-008-slide-ur-05.png",
        "dark": False,
        "title": "غلط پڑھائیں ۱ تا ۳",
        "body": (
            '<ul class="bullets">'
            '<li><span class="dot"></span><span>صرف عنوان</span></li>'
            '<li><span class="dot"></span><span>تاریخ اندھا پن</span></li>'
            '<li><span class="dot"></span><span>دائرہ کار پھیلانا</span></li>'
            "</ul>"
        ),
    },
    {
        "name": "POST-008-slide-ur-06.png",
        "dark": False,
        "title": "غلط پڑھائیں ۴ و ۵",
        "body": (
            '<ul class="bullets">'
            '<li><span class="dot"></span><span>مسودہ بطور حتمی حکم</span></li>'
            '<li><span class="dot"></span><span>فوٹ نوٹ چھوڑنا</span></li>'
            "</ul>"
        ),
    },
    {
        "name": "POST-008-slide-ur-07.png",
        "dark": False,
        "title": "پانچ سوال",
        "body": (
            '<div class="truths">'
            '<div class="truth"><span class="n">۱</span><span>جاری کنندہ؟</span></div>'
            '<div class="truth"><span class="n">۲</span><span>تاریخ / میعاد؟</span></div>'
            '<div class="truth"><span class="n">۳</span><span>دائرہ کار؟</span></div>'
            '<div class="truth"><span class="n">۴</span><span>عمل یا معلومات؟</span></div>'
            '<div class="truth"><span class="n">۵</span><span>اصل کاپی کہاں؟</span></div>'
            "</div>"
        ),
    },
    {
        "name": "POST-008-slide-ur-08.png",
        "dark": True,
        "title": "یاد رکھیں",
        "body": (
            '<p class="sub" style="font-size:34px">موٹی سطر پورا حکم نہیں۔</p>'
            '<p class="sub" style="margin-top:20px">اگلا: مقامی حکومت کس کام کی ہے</p>'
            '<div class="cta-pill">محفوظ کریں · فالو کریں · پوسٹ ۸</div>'
        ),
    },
]
...
SLIDES_EN = [
    {
        "name": "POST-008-slide-en-01.png",
        "dark": True,
        "title": 'Did you <span class="hl">see</span> the notice, or <span class="hl">read</span> it?',
        "body": '<p class="sub">Issuer · date · scope</p><p class="sub" style="margin-top:18px">Post 8</p>',
    },
    {
        "name": "POST-008-slide-en-02.png",
        "dark": False,
        "title": "Office / school group",
        "body": (
            '<ul class="bullets">'
            '<li><span class="dot"></span><span>Bold line: timing changed</span></li>'
            '<li><span class="dot"></span><span>Plans rearranged</span></li>'
            '<li><span class="dot"></span><span>Footnote unread</span></li>'
            "</ul>"
        ),
    },
    {
        "name": "POST-008-slide-en-03.png",
        "dark": False,
        "title": "From Post 7",
        "body": (
            '<ul class="bullets">'
            '<li><span class="dot"></span><span>Forward ≠ proof</span></li>'
            '<li><span class="dot"></span><span>Today: how to read a notice</span></li>'
            '<li><span class="dot"></span><span>Title ≠ full rule</span></li>'
            "</ul>"
        ),
    },
    {
        "name": "POST-008-slide-en-04.png",
        "dark": False,
        "title": "Three checks",
        "body": (
            '<ul class="bullets">'
            '<li><span class="dot"></span><span>Issuer</span></li>'
            '<li><span class="dot"></span><span>Date / validity</span></li>'
            '<li><span class="dot"></span><span>Scope</span></li>'
            '<li><span class="dot"></span><span>(+ action or information)</span></li>'
            "</ul>"
        ),
    },
    {
        "name": "POST-008-slide-en-05.png",
        "dark": False,
        "title": "Misreadings 1-3",
        "body": (
            '<ul class="bullets">'
            '<li><span class="dot"></span><span>Headline-only</span></li>'
            '<li><span class="dot"></span><span>Date-blind</span></li>'
            '<li><span class="dot"></span><span>Scope creep</span></li>'
            "</ul>"
        ),
    },
    {
        "name": "POST-008-slide-en-06.png",
        "dark": False,
        "title": "Misreadings 4-5",
        "body": (
            '<ul class="bullets">'
            '<li><span class="dot"></span><span>Draft as binding</span></li>'
            '<li><span class="dot"></span><span>Footnote skip</span></li>'
            "</ul>"
        ),
    },
    {
        "name": "POST-008-slide-en-07.png",
        "dark": False,
        "title": "Five questions",
        "body": (
            '<div class="truths">'
            '<div class="truth"><span class="n">1</span><span>Issuer?</span></div>'
            '<div class="truth"><span class="n">2</span><span>Date / validity?</span></div>'
            '<div class="truth"><span class="n">3</span><span>Scope?</span></div>'
            '<div class="truth"><span class="n">4</span><span>Action or information?</span></div>'
            '<div class="truth"><span class="n">5</span><span>Primary copy where?</span></div>'
            "</div>"
        ),
    },
    {
        "name": "POST-008-slide-en-08.png",
        "dark": True,
        "title": "Remember",
        "body": (
            '<p class="sub" style="font-size:34px">A bold line is not the whole rule.</p>'
            '<p class="sub" style="margin-top:20px">Next: what local government is for</p>'
            '<div class="cta-pill">Save · Follow · Post 8</div>'
        ),
    },
]
...
def main() -> None:
    ...
    print("POST-008 visual set complete ->", ROOT)
